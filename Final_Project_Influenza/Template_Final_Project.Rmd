...
All differential equations come from class notes and assignments.
...
text_determ = paste("Figure 1. ", "Deterministic SEIR Models for Seasonal Influenza (A) and H1N1 Pandemic Influenza","\n","(B). Represents static outputs for the given parameters. Calculated using deterministic differencing equations.")
...
text_stoch = paste("Figure 2. Stochastic SEIR models for Seasonal influenza (A) and H1N1 pandemic influenza (B).", "\n", "Stochastic plots represent average compartmental count of 100 model iterations with a 90% Monte Carlo", "\n", "confidence interval ribbon. Calculated using stochastic differencing equations.")
...
text_variable = paste("Figure 3. Stochastic SEIR models for Pandemic Influenza with different parameters for Infectious Period (D):\n 5 days(A), 6 days (B), and 7 days(C).  Stochastic plots represent average compartmental count of \n100 model iterations with a 90% Monte Carlo confidence interval ribbon. Calculated using stochastic \ndifferencing equations.")
...
```{r}
#arrange graphs together + figure legend
text = paste("Figure 5. Summary of the deterministic SEIR models and stochastic SEIR models created for seasonal and H1N1 \npandemic influenza (A = Seasonal Deterministic, B = Pandemic Deterministic, C = Seasonal Stochastic, D= Pandemic \nStochastic). Both models show the average course of a hypothetical influenza outbreak in seasonal and pandemic \nconditions. Deterministic plots represent static outputs for the given parameters. Stochastic plots represent average \ncompartmental count of 100 model iterations with a 90% Monte Carlo confidence interval ribbon.")
